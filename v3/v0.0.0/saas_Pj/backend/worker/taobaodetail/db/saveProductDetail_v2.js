...
/**
 * V2 API 응답 데이터를 받아 해당 상품의 상세정보를 DB의 여러 상품상세정보 테이블에 저장하는 함수
 * @param {Object} productDetailV2 - V2 API 응답 데이터
 * @param {number} userid - 사용자 ID
 * @param {Object} job - 작업 데이터 (productId, productName 등)
 */
export async function saveProductDetail_v2(productDetailV2, userid, job) {
  ...
  try {
    ...
    // V2 API에서는 카테고리 정보가 명시적이지 않으므로 sameCategoryId 사용하거나 랜덤 생성
    let catid;
    let catName = '';
